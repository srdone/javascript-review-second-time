...
//code here
var findItem = function(chooser, arr) {
  var toFind = chooser();
  alert(toFind + ' is in ' + arr + '?');
...
findItem(getRandomArbitrary, randomArray);
...
alert('The longest word in ' + sentence + ' is ' + longest(sentence));
